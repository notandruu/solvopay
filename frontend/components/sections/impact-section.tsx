const metrics = [
  { value: "$0", label: "Gas Cost Per Voucher", description: "off-chain by design" },
  { value: "1 tx", label: "On-Chain Settlements", description: "once per session" },
  { value: "<1ms", label: "Voucher Latency", description: "signed off-chain" },
  { value: "3%", label: "Yield on Locked USDC", description: "via Aave V3" },
]
    ...
    <section className="px-6 py-24 bg-zinc-900/20">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <p className="text-sm font-medium text-zinc-500 uppercase tracking-wider mb-4">THE PROTOCOL</p>
          <h2 className="font-display text-3xl md:text-4xl font-bold text-zinc-100 mb-4">Built for machine-speed payments</h2>
